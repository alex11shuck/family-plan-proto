...
export function NavMenu() {
  ...
  const routes = [
    ...
    { path: "/individual-confirmation", label: "Individual Purchase", section: "Option 1 - Upsell Flow" },
    { path: "/family-upsell", label: "Family Plan Upsell" },
    { path: "/family-upsell-confirmation", label: "Upsell Confirmation" },
