  ...
  return (
    <div className="bg-gradient-to-b from-[#7500d0] to-[#301f95] overflow-clip relative size-full flex items-center justify-center">
      <div className="bg-gradient-to-b from-[#7500d0] to-[#301f95] overflow-clip relative rounded-[40px] w-[375px] h-[812px]">
        ...
        {/* Back Button */}
        <Link to="/" className="absolute left-[24px] top-[59px] size-[24px] z-10">
        ...
        {/* Premium Badge */}
        <div className="absolute left-[24px] right-[24px] top-[160px]">
        ...
        {/* Settings List */}
        <div className="absolute left-[24px] right-[24px] top-[320px] bottom-[60px] overflow-y-auto">
          {/* Family Plan */}
          <Link
            to="/seat-management"
            className="bg-white/10 backdrop-blur-sm rounded-[12px] p-[16px] border border-white/20 mb-[12px] block"
          >
            <div className="flex items-center justify-between">
              ...
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M7 4L13 10L7 16" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.4"/>
              </svg>
            </div>
          </Link>
          ...
          <div className="space-y-[12px]">
              ...
              <div className="flex items-center gap-[12px]">
                <div className="size-[40px] rounded-full bg-white/20 flex items-center justify-center shrink-0">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <line x1="7" y1="8" x2="13" y2="8" stroke="#7500d0" strokeWidth="1.5"/>
                    <line x1="7" y1="11" x2="13" y2="11" stroke="#7500d0" strokeWidth="1.5"/>
                    <line x1="7" y1="14" x2="10" y2="14" stroke="#7500d0" strokeWidth="1.5"/>
                  </svg>
                </div>
                <div className="flex-1">
                  <p className="font-['DIN_OT:Medium',sans-serif] text-[16px] text-white mb-[2px]">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-[12px] p-[16px] border border-white/20">
              <div className="flex items-center gap-[12px]">
                <div className="size-[40px] rounded-full bg-white/20 flex items-center justify-center shrink-0">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18Z" fill="white" opacity="0.8"/>
                    <path d="M10 6V10L13 13" stroke="#7500d0" strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                </div>
                <div className="flex-1">
                  <p className="font-['DIN_OT:Medium',sans-serif] text-[16px] text-white mb-[2px]">
